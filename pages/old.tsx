...
const funZoneItems = [
  {
    ...
    preview_image: '/games/waynemo_preview.png',
    image_text: 'Wayne Mo',
  },
  {
    url: '/sollewitt',
    preview_image: '/games/sol_preview.png',
    image_text: 'Sol LeWitt',
  },
  {
    url: '/axisrecall',
    preview_image: '/games/axisrecall_preview.png',
    image_text: 'Axis Recall',
  },
  {
    url: 'https://wassuh.com',
    preview_image: '/games/wassuh_preview.png',
    image_text: 'Coit Cache',
  },
  {
    url: '/room',
    preview_image: '/games/room_preview.png',
    image_text: 'Room',
  },
  {
    url: '/earth',
    preview_image: '/games/earth_preview.png',
    image_text: 'Earth',
  },
];
...
export default function BlogIndex({ posts = [] }: { posts: PostMeta[] }) {
  ...
  const getTagClassName = (tag: string, baseSize: 'sm' | 'xs') => {
    ...
    const colorClasses =
      tagColors[tag] || 'bg-gray-50 text-gray-700 border border-gray-200';
  ...
  return (
    <>
      <Seo title="Archive" path="/old/" noindex />
          ...
          <div className="space-y-8">
            ...
            <div className="max-w-2xl">
              <p className="text-2xl md:text-3xl text-gray-900 leading-relaxed font-light">
                I make stuff. A lot of stuff. Engineer / Artist currently
                leveraging
