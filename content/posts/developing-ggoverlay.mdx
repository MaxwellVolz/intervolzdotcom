...
description: "A real-time game-state inference engine in Rust: DXGI capture, cheap per-frame heuristics, and YOLO escalation over gRPC. First target: Arc Raiders."
technical: false
draft: false
work: false
pinned: false
