...
I authored internal design specs that **defined what "passing units" on the production floor meant**:
...
* Developed an automated Python harness with CLI-based test control and YAML-driven config.
