...
description: Building a Crazy Taxi-inspired fleet management game in the browser
  with React, Three.js and Blender. A one month journey from first commit to
  playable demo.
technical: false
draft: false
work: false
