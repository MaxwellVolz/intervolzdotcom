...
description: "Building a Crazy Taxi-inspired fleet management game in the browser with React, Three.js and Blender — one month from first commit to playable demo."
technical: false
draft: false
work: false
pinned: true
...
![Wayne Mo - title screen placeholder](/imgs/wayne_mo_logo.gif "Wayne Mo - title screen placeholder")
...
![Early city with road loop](/imgs/wayne_mo_foundation.png "Early city with road loop")
...
![Blender scene with path node markers](/imgs/wayne_mo_blender_nodes.png "Blender scene with path node markers")
...
![Gameplay with color-coded deliveries](/imgs/wayne_mo_phase1.png "Gameplay with color-coded deliveries")
...
![Score multiplier with directional arrows](/imgs/wayne_mo_multiplier.png "Score multiplier with directional arrows")
...
![Apartment scene with desk progression](/imgs/wayne_mo_apartment.png "Apartment scene with desk progression")
...
![Maxwell character in dialogue scene](/imgs/wayne_mo_maxwell.png "Maxwell character in dialogue scene")
