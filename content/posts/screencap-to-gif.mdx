...
description: "Making high-quality GIFs without bloated GUI apps: capture with OBS, then process with ffmpeg and gifsicle for tiny files and predictable output."
technical: false
draft: true
work: false
