...
description: "Building TerraZed, a React app that turned raw mmWave telemetry from a high-altitude pseudo-satellite into something field engineers could actually read."
technical: false
draft: false
work: true
tags: react web @meta
