---
title: Tracking AI Adoption With Em Dashes
date: 2025-12-11T13:57:00.000-08:00
description: "Across 19 years of Reddit comments, the rise in em dash usage tracks the normalization of AI-assisted writing. Here is the data pipeline and the chart."
technical: true
draft: false
work: false
tags: web dataviz
...
![First pass at the em dash chart, rebuilt on a proper charting library](/uploads/emdash-observer/emdash_first_pass.png)

### Jonatron responds!

![Jonatron's reply in the Hacker News thread](/uploads/emdash-observer/jonatron_comments.png)
...
![Hand-drawn layout sketch for the Em Dash Observer interface](/uploads/emdash-observer/emdash_sketch.jpeg)

Data Filtering:

![Sketch of the data filtering controls](/uploads/emdash-observer/emdash_filters.jpeg)
...
![The MUI X charts overview page the sketch was based on](/uploads/emdash-observer/muix_example.png)
...
![MUI X pricing page putting time range and zoom behind a subscription](/uploads/emdash-observer/scam_pricing.png)
...
![The last Material-styled pass at the chart before the pivot](/uploads/emdash-observer/emdash_material.png)
