...
The entire concept (as it seems to me) is to pull you in with the most basic looking charts and put generic features like *setting a time range* or *zoom* behind a paywall.
...
While awaiting the building frustration to completely rip *Material* out of my stack I will simple replace the chart with...
...
More to come, maybe. Check out the demo: [Em Dash Observer](https://intervolz.com/emdash-observer/)
