...
description: 'A contacts app organized around how you know people, not their names: one screen, a bubble graph, and filter chips generated from your own data. No account.'
cover: ''
technical: true
draft: true
work: false
...
Acquaintances is a contacts app organized around how you know people. The whole
...
center while everyone else drifts out and dims.
...
![The app at rest on a phone.](/imgs/acq_resting.png 'The app at rest on a phone. Fifty people, the chip row generated from their own data: Monk's Café 12, Kevin's place 4. The bar along the bottom names the cast you are looking at.')
...
visualization _is_ the product, and it runs on an imperative `<canvas>` with a
...
row narrows with you. Shared attributes bend the layout but are never materialized as
