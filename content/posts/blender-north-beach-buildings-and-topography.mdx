---
title: North Beach Buildings and Topography with BLOSM + USGS
date: 2025-07-02T17:01:00.000-07:00
description: "Combining BLOSM building footprints with USGS elevation data in Blender, then face-projecting the buildings onto real terrain with a Python script."
cover: /uploads/greasepencilcurbs.png
technical: false
draft: false
tags: python blender
---
![Low-poly render of North Beach, San Francisco, with buildings set on USGS terrain](/uploads/north_beach_render.png)
