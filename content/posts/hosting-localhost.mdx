...
description: "How to build and self-host a modern blog from your own hardware: Git-backed content, visual editing, Jenkins deploys, and NGINX behind a Cloudflare Tunnel."
technical: false
draft: false
work: false
...
- [Deployment Architecture](#deployment-architecture)
  ...
  - [3. Cloudflare Tunnel](#3-cloudflare-tunnel)
    ...
    - [Check Status and restart `cloudflared`](#check-status-and-restart-cloudflared)
