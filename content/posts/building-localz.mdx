---
title: Localz - Multiplayer Game Experience
date: 2025-07-07T10:24:00.000-07:00
description: "Building Localz, a multiplayer game set in a model of North Beach, San Francisco — Unity locomotion, NPC spawners, and a gameplay loop still being found."
technical: false
draft: false
work: false
devlog: true
...
| Major Task               |                       Status |
| ------------------------ | ---------------------------: |
| Multiplayer 0.0.1 Demo   |                    Completed |
| Player Locomotion        |                      Working |
| NPCs                     | Spawners, Waypoints, Pathing |
| North Beach Model        |             1/10 is generous |
| Core Gameplay Mechanic   |                   Unknown(?) |
| NPC interactions         |              Not implemented |
| Inventory                |              Not implemented |
| Lots of important things |              Not implemented |
...
![KanBan Board](/uploads/tasks.png "KanBan Board")
