...
- Character movement: Diving / Jumping
  - lerp angle of character to upside-down (landing on head) based on vertical speed
  - if oververtical on land then trigger roll animation
  - if character jumps(spacebar) then dives(spacebar again) set tilt to 45 degrees and give boost to direction
- Character movement:
  - movement in a direction should tiltthe character in that direction up to 15degrees
