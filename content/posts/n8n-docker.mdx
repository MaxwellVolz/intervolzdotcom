...
date: 2025-01-05T12:57:00.000-08:00
description: "An automated shortform video pipeline built on n8n and DeepSeek 3.1: script generation, local TTS, Whisper captions, music and publishing — all free."
cover: ""
draft: false
work: false
technical: true
...
5. Add **Authorized Redirect URI**:
   ...
   ```
6. Save new **Client ID** and **Client Secret**.
