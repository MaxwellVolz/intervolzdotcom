...
description: "Adding a minimal FastAPI backend to a self-hosted static blog — contact forms, webhooks and POST endpoints behind NGINX and a Cloudflare Tunnel."
technical: false
draft: true
work: false
