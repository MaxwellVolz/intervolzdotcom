...
This article continues the **localhost hosting** series and explains how to add a **minimal FastAPI backend** to the same stack used by the static blog.
...
- Adding email delivery (SES/Postmark)
- Jenkins deploying backend code
- HMAC-signed form submissions
- A single binary build instead of Python

Say the word and I will write the next one in the series.
```
